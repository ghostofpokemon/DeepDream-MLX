...
║    ▼                                                                    ║
║  ┏━ AlexNet (2012) ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓  ║
║  ┃ GPU Accelerated Vision. Modern AI Ignite.                         ┃  ║
║  ┗━┳━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛  ║
║    │                                                                    ║
║    ╠════════════════════════════════╦═════════════════════════════╗     ║
║    ▼                                ▼                             ▼     ║
║ ┏━━━━━━━━━━━━━━━━━━━━━━━┓      ┏━━━━━━━━━━━━━━━━━━━━━━━┓     ┏━━━━━━━━┓ ║
║ ┃   THE OXFORD BRANCH   ┃      ┃   THE GOOGLE BRANCH   ┃     ┃   MS   ┃ ║
║ ┃ "Go Deeper" (VGG)     ┃      ┃ "Go Wider" (Inception)┃     ┃ ResNet ┃ ║
║ ┗━┳━━━━━━━━━━━━━━━━━━━━━┛      ┗━┳━━━━━━━━━━━━━━━━━━━━━┛     ┗━┳━━━━━━┛ ║
║   │                              │                             │        ║
║   ┣━━━━━━━╦━━━━━━━┓              │                             │        ║
║   ▼       ▼       ▼              ▼                             ▼        ║
...
║   │       │       │              │                             │        ║
║   │       │       └─ (Stylist)   │                             │        ║
║   └───────┼───────── (Painter)   └─ (Hallucinator)             └─ (Mod) ║
║           │              │              │                             │ ║
║           ▼              ▼              ▼                             ▼ ║
║     vgg19_mlx.npz  vgg16_mlx.npz  googlenet_mlx.npz      resnet50_mlx.npz
║                                                                         ║
╚═════════════════════════════════════════════════════════════════════════╝
```
